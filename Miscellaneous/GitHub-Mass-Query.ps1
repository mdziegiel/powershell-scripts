...
.SCRIPT      : GitHub-Mass-Query
.SYNOPSIS    : Massively search GitHub for keywords.
.DESCRIPTION : Pulled from llZektorll/Microsoft-PowerShell-Fastlane/01 - ToolKits/01.4 - GitHub Mass Query.ps1.
#>
