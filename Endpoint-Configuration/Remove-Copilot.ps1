...
.SCRIPT      : Remove-Copilot
.SYNOPSIS    : Remove Copilot from Windows 10.
.DESCRIPTION : Pulled from llZektorll/Microsoft-PowerShell-Fastlane/Windows/Windows 10/Remove Copilot.ps1.
#>
