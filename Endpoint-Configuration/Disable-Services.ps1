...
.SCRIPT      : Disable-Services
.SYNOPSIS    : Disable selected Windows services.
.DESCRIPTION : Pulled from llZektorll/Microsoft-PowerShell-Fastlane/Windows/Windows 10/Disable Services.ps1. Review WSearch (Windows Search) and wscsvc (Security Center) before running on end-user machines; stopping them affects search and security-center behavior.
#>

# NOTE: WSearch and wscsvc are more impactful than the rest of the list; review before running on end-user machines.
