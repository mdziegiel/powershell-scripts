...
SCRIPT      : Drive Mapping
SYNOPSIS    : Maps network drives for users and supports recurring execution
DESCRIPTION : Performs network drive mappings with PowerShell. When run under
              SYSTEM context, the script creates a scheduled task to ensure
              it runs again at each user logon

SOURCE      : Based on intune-drive-mapping-generator
REFERENCE   : https://intunedrivemapping.azurewebsites.net
ORIGINAL    : Nicola Suter | nicolonsky tech
==============================================================================
#>
...
$driveMappingJson = '[{"Path":"\\\\hkfiles\\e","DriveLetter":"Z","Label":"Shared Drive","Id":0,"GroupFilter":null},{"Path":"\\\\hk1\\Database","DriveLetter":"L","Label":"Database","Id":2,"GroupFilter":null},{"Path":"\\\\hk1\\Nicelabel","DriveLetter":"N","Label":"NiceLabel","Id":3,"GroupFilter":null}]'
