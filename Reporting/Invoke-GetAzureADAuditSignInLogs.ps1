...
SCRIPT      : Invoke-GetAzureADAuditSignInLogs
SYNOPSIS    : Get the AzureAD Audit Sign-In Logs and create several CSV files
DESCRIPTION : Get the AzureAD Audit Sign-In Logs and create several CSV files
================================================================================
#>
