...
SCRIPT      : Get-AuditGuestTeams
SYNOPSIS    : This Script function will create a report that will help IT PROs
              to Monitor and Audit Guest users
DESCRIPTION : This Script function will create a report that will help IT PROs
              to Monitor and Audit Guest users. The report
              generated by the script will show the following
              details: 1. How many Microsoft 365 Groups contains
              Guest…
================================================================================
#>
param(
