...
SCRIPT      : ListADObjectsOnSelectedOU
SYNOPSIS    : Lists AD objects from a graphically selected OU and exports common
              name and description to CSV.
DESCRIPTION : Lists AD objects from a graphically selected OU and exports common
              name and description to CSV.
================================================================================
#>
