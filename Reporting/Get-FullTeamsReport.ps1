...
SCRIPT      : Get-FullTeamsReport
SYNOPSIS    : Connects to Microsoft Teams and exports a full report of teams,
              channels, and members.
DESCRIPTION : Connects to Microsoft Teams and exports a full report of teams,
              channels, and members.
================================================================================
#>
param(
