...
SCRIPT      : Get-ComputersToRebootAfterUpdate
SYNOPSIS    : Lists AD computers with a pending reboot after Windows Update KB
              installation and exports them to CSV.
DESCRIPTION : Lists AD computers with a pending reboot after Windows Update KB
              installation and exports them to CSV.
================================================================================
#>
