...
SCRIPT      : Get-TeamsChannelUsersReport
SYNOPSIS    : Connects to Microsoft Graph and Microsoft Teams to report users,
              roles, and shared-channel membership across teams.
DESCRIPTION : Connects to Microsoft Graph and Microsoft Teams to report users,
              roles, and shared-channel membership across teams.
================================================================================
#>
#Requires -Modules Microsoft.Graph.Authentication, Microsoft.Graph.Groups, Microsoft.Graph.Users, Microsoft.Graph.Teams, MicrosoftTeams
[CmdletBinding()]
param (
