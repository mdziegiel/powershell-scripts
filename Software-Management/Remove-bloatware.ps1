...
SYNOPSIS    : Removes built-in Windows 10 apps.
DESCRIPTION : Removes pre-installed Windows 10 apps and common consumer
              bloatware so fresh endpoints start from a cleaner
              baseline.
================================================================================
#>
$apps = @(
