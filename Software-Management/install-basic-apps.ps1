...
SCRIPT      : install-basic-apps
SYNOPSIS    : This PowerShell script installs basic Windows apps such as
              browser, e-mail client, etc
DESCRIPTION : This PowerShell script installs basic Windows apps such as
              browser, e-mail client, etc. NOTE: Apps from
              Microsoft Store are preferred (due to security and
              automatic updates).
================================================================================
#>
try {
