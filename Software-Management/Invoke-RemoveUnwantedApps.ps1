...
SCRIPT      : Invoke-RemoveUnwantedApps
SYNOPSIS    : Remove a few apps we don't like to have installed any longer, we
              use WinGet to do so
DESCRIPTION : Remove a few apps we don't like to have installed any longer, we
              use WinGet to do so
================================================================================
#>
