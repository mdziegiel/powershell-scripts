...
SCRIPT      : Download_Themes
SYNOPSIS    : Downloads Microsoft Windows themes.
DESCRIPTION : Downloads Microsoft theme packs to a local folder so wallpaper and
              lock screen branding assets can be distributed
              consistently.
================================================================================
#>
param (
