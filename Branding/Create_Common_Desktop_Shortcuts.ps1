...
SCRIPT      : Create_Common_Desktop_Shortcuts
SYNOPSIS    : Creates common desktop shortcuts.
DESCRIPTION : Creates a standard set of desktop shortcuts for common
              applications so the desktop layout stays consistent.
================================================================================
#>
$programs = @{
