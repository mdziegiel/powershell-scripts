...
SCRIPT      : Create_Common_StartMenu_Shortcuts
SYNOPSIS    : Creates common Start Menu shortcuts.
DESCRIPTION : Creates a standard set of Start Menu shortcuts for common
              applications so users get a consistent launcher
              layout.
================================================================================
#>
$programs = @{
