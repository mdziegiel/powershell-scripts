...
SYNOPSIS    : This PowerShell script sets the given image file as desktop
              wallpaper (.JPG or .PNG supported)
DESCRIPTION : This PowerShell script sets the given image file as desktop
              wallpaper (.JPG or .PNG supported)
================================================================================
#>
