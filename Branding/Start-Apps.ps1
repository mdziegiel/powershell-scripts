...
SCRIPT      : Start-Apps
SYNOPSIS    : Launches Start Menu shortcuts.
DESCRIPTION : Launches a curated set of Start Menu shortcuts and shortcuts-based
              app entries for quick access to standard tools.
================================================================================
#>
param (
