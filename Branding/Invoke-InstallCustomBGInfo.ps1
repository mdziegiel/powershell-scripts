...
SCRIPT      : Invoke-InstallCustomBGInfo
SYNOPSIS    : Download an install the latest BGInfo on an internal server
DESCRIPTION : Download an install the latest BGInfo on an internal server
================================================================================
#>
