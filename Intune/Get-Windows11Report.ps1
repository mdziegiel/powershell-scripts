...
SYNOPSIS    : Connects to Microsoft Graph, retrieves all managed Windows
              devices, calculates Windows 11 adoption percentages,
              builds an HTML report with a pie chart and device
              table, and sends it as an email attachment.
DESCRIPTION : Connects to Microsoft Graph, retrieves all managed Windows
              devices, calculates Windows 11 adoption percentages,
              builds an HTML report with a pie chart and device
              table, and sends it as an email attachment.
================================================================================
