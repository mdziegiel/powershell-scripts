...
SYNOPSIS    : Queries Microsoft Graph for devices enrolled in the past 7 days,
              generates a CSV report, and sends it as an email
              attachment via the Graph Mail API.
DESCRIPTION : Queries Microsoft Graph for devices enrolled in the past 7 days,
              generates a CSV report, and sends it as an email
              attachment via the Graph Mail API.
================================================================================
#>
