...
SCRIPT      : Application_Get_Assign
SYNOPSIS    : Authenticates to Microsoft Graph, enumerates Intune applications,
              and exports assignment and deployment details to a
              report.
DESCRIPTION : Authenticates to Microsoft Graph, enumerates Intune applications,
              and exports assignment and deployment details to a
              report.
================================================================================
#>
