...
SCRIPT      : ManagedDevices_Get
SYNOPSIS    : Authenticates to Microsoft Graph and exports Intune managed device
              inventory and compliance details.
DESCRIPTION : Authenticates to Microsoft Graph and exports Intune managed device
              inventory and compliance details.
================================================================================
#>
