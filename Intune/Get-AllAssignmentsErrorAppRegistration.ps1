...
SCRIPT      : Get-AllAssignmentsErrorAppRegistration
SYNOPSIS    : Retrieves all failed configuration profile and app assignments in
              the tenant, exports them as CSV files, and sends an
              email report with attachments via Microsoft Graph
DESCRIPTION : Retrieves all failed configuration profile and app assignments in
              the tenant, exports them as CSV files, and sends an
              email report with attachments via Microsoft Graph.
              Designed for Azure Automation with app…
================================================================================
#>
