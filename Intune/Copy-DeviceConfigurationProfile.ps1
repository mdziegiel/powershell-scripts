...
SCRIPT      : Copy-DeviceConfigurationProfile
SYNOPSIS    : Copy a device configuration profile in Intune
DESCRIPTION : Copy a device configuration profile in Intune. This script does
              not work with ADMX templates. Uses Microsoft Graph
              API via the Microsoft.Graph.Authentication module.
================================================================================
#>
