...
SCRIPT      : CompliancePolicy_Export
SYNOPSIS    : Authenticates to Microsoft Graph, enumerates Intune compliance
              policies, and exports their settings to a report for
              review.
DESCRIPTION : Authenticates to Microsoft Graph, enumerates Intune compliance
              policies, and exports their settings to a report for
              review.
================================================================================
#>
