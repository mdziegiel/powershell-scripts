...
SCRIPT      : Add-DelegationRights
SYNOPSIS    : Adds mailbox delegation rights for Office 365 users, with or
              without automapping.
DESCRIPTION : Adds mailbox delegation rights for Office 365 users, with or
              without automapping.
================================================================================
#>
