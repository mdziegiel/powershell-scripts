...
SCRIPT      : Get-WTCAPolicy
SYNOPSIS    : Connects to Microsoft Graph and reads Conditional Access policy
              details.
DESCRIPTION : Connects to Microsoft Graph and reads Conditional Access policy
              details.
================================================================================
#>
