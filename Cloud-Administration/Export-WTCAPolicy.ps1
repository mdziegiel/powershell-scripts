...
SCRIPT      : Export-WTCAPolicy
SYNOPSIS    : Connects to Microsoft Graph and exports Conditional Access
              policies and related settings.
DESCRIPTION : Connects to Microsoft Graph and exports Conditional Access
              policies and related settings.
================================================================================
#>
