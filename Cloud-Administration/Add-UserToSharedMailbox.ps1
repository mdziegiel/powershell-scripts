...
SCRIPT      : Add-UserToSharedMailbox
SYNOPSIS    : Grants Office 365 users access to a shared mailbox, with or
              without automapping.
DESCRIPTION : Grants Office 365 users access to a shared mailbox, with or
              without automapping.
================================================================================
#>
