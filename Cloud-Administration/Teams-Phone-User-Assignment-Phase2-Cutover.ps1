...
SCRIPT      : Teams-Phone-User-Assignment-Phase2-Cutover
SYNOPSIS    : Assign phone numbers and complete Teams phone cutover
DESCRIPTION : Assign phone numbers and complete Teams phone cutover
================================================================================
#>
