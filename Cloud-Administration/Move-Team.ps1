...
SCRIPT      : Move-Team
SYNOPSIS    : Copies channels and files from one Team to another, with a REPORT
              mode for read-only comparison and an EXECUTE mode
              that can add members, create channels, and copy
              files between teams.
DESCRIPTION : Copies channels and files from one Team to another, with a REPORT
              mode for read-only comparison and an EXECUTE mode
              that can add members, create channels, and copy
              files between teams.
================================================================================
#>
#Requires -Modules MicrosoftTeams, AzureAD
Function Set-Mode{
