...
SCRIPT      : Get-WTAzureADGroup
SYNOPSIS    : Connects to Microsoft Graph and lists Azure AD or Entra groups.
DESCRIPTION : Connects to Microsoft Graph and lists Azure AD or Entra groups.
================================================================================
#>
