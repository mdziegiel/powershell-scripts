...
SCRIPT      : Update-UPNandLicence
SYNOPSIS    : Reads a CSV of users, updates each account’s UPN, usage location,
              and assigned Microsoft 365 license, and writes
              transcript and subject logs.
DESCRIPTION : Reads a CSV of users, updates each account’s UPN, usage location,
              and assigned Microsoft 365 license, and writes
              transcript and subject logs.
================================================================================
#>
