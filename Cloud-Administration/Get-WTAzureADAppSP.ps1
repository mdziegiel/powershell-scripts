...
SCRIPT      : Get-WTAzureADAppSP
SYNOPSIS    : Connects to Microsoft Graph and reports Azure AD or Entra
              application service principals.
DESCRIPTION : Connects to Microsoft Graph and reports Azure AD or Entra
              application service principals.
================================================================================
#>
