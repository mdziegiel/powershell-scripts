...
SCRIPT      : New-WTAzureADGroup
SYNOPSIS    : Connects to Microsoft Graph and creates Azure AD or Entra groups.
DESCRIPTION : Connects to Microsoft Graph and creates Azure AD or Entra groups.
================================================================================
#>
